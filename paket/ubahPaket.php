...
?>
    <h3>Ubah Paket</h3>
    <form action="prosesUbahPaket.php" method="post"><input type="hidden" name="id" value="<?=$dt_paket['id']?>">
    Jenis :
    <?php 
        $arr_jenis=array('Kiloan'=>'Kiloan','Selimut'=>'Selimut','Bed Cover'=>'Bed Cover','Kaos'=>'Kaos');
        ?>
